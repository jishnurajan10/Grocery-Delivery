        ...
        <div className="flex flex-col h-full">
          ...
          <div className="p-4 border-t border-gray-200">
            <div className="flex items-center text-sm text-gray-500"> 
              <div className="w-10 h-10 bg-black rounded-full mr-3 text-3xl text-center text-white">A</div>
              <div>
          ...
          <div className="flex items-center justify-between px-6 py-4">
            ...
            <div className="hidden md:flex items-center spaxe-x-4">
              <div className="text-sm text-gray-500">
                <p
                  onClick={logout}
                  className="bg-primary cursor-pointer text-white rounded-3xl px-4 py-1.5 text-lg hover:bg-amber-700 "
                >
                  logout
                </p>
              </div>
